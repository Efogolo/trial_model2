...
FEATURES = [
    "sessions_3d", "active_days_3d", "day1_share", "listen_share",
    "avg_session_minutes", "total_minutes_3d", "country", "device_type",
]

#function to create features from the raw data, including sessions and active days in the first 3 days, share of sessions on day 1, share of listen sessions, and average session minutes
...
def encode_features(df: pd.DataFrame) -> pd.DataFrame:
    return pd.get_dummies(df[FEATURES], columns=["country", "device_type"])